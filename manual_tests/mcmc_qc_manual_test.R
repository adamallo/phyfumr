...
convergence_single_patient <- mcmc_qc_patient(trees_files,out_dir = out_dir,plot_dir = plot_dir)
all_convergence <- mcmc_qc(file_dir = inDir,out_dir = out_dir, plot_dir = plot_dir, n_cores = 8, burnin_p = 0.1)
